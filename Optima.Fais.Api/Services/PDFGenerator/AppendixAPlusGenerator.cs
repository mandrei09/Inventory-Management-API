...
{
    public class AppendixAPlusGenerator : IAppendixAPlusGenerator
    {
        ...
        public AppendixAPlusGenerator(IConfiguration configuration, IInventoryRepository inventoryRepository,
        ...
        public async Task<PdfDocumentResult> GenerateDocumentAsync(int inventoryId, ReportFilter reportFilter, DateTime? inventoryDateEnd)
        {
            ...
            var items = await this._assetRepository.GetInventoryPlusListAsync(inventoryId, reportFilter);
            ...
            section.PageSetup.TopMargin = Unit.FromMillimeter(71.3);
            ...
            signatureSection.PageSetup.TopMargin = Unit.FromMillimeter(50);
            ...
            Model.Division division, Model.CostCenter costCenter, ReportFilter reportFilter, DateTime? inventoryDateEnd, decimal totalValue, bool complete = true)
        {
            ...
            row1.Cells[2].AddParagraph($"PLUSURI DE INVENTAR\r\n(Anexa 2)\r\n\r\nData: {String.Format("{0:dd.MM.yyyy}", inventoryDateEnd)}");
            //row1.Cells[2].AddParagraph($"LISTA DE INVENTARIERE\r\n\r\nData: 31.03.2022");
