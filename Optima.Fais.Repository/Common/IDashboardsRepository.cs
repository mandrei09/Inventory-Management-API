...
{
    public interface IDashboardsRepository : IRepository<Model.Dashboard>
    {
        ...
        IEnumerable<Model.AssetMonthDetail> GetReportData(DashboardFilter assetFilter, string includes, Sorting sorting, Paging paging, out DashboardTotal depTotal);
