...
namespace Optima.Fais.Data.Migrations
{
    ...
    [Migration("20191217194437_AddAssetOPTransferTables")]
    partial class AddAssetOPTransferTables
    {
            ...
            modelBuilder.Entity("Optima.Fais.Model.AssetOp", b =>
                {
                    ...
                    b.Property<int?>("AssetNatureFinalId");

                    b.Property<int?>("AssetNatureIdFinal");

                    b.Property<int?>("AssetNatureIdInitial");

                    b.Property<int?>("AssetNatureInitialId");
                    ...
                    b.Property<int?>("BudgetManagerFinalId");

                    b.Property<int?>("BudgetManagerIdFinal");

                    b.Property<int?>("BudgetManagerIdInitial");

                    b.Property<int?>("BudgetManagerInitialId");
                    ...
                    b.Property<int?>("DimensionFinalId");

                    b.Property<int?>("DimensionIdFinal");

                    b.Property<int?>("DimensionIdInitial");

                    b.Property<int?>("DimensionInitialId");
                    ...
                    b.Property<int?>("ProjectFinalId");

                    b.Property<int?>("ProjectIdFinal");

                    b.Property<int?>("ProjectIdInitial");

                    b.Property<int?>("ProjectInitialId");
                    ...
                    b.HasIndex("AssetNatureFinalId");

                    b.HasIndex("AssetNatureInitialId");
                    ...
                    b.HasIndex("BudgetManagerFinalId");

                    b.HasIndex("BudgetManagerInitialId");
                    ...
                    b.HasIndex("DimensionFinalId");

                    b.HasIndex("DimensionInitialId");
                    ...
                    b.HasIndex("ProjectFinalId");

                    b.HasIndex("ProjectInitialId");
            ...
            modelBuilder.Entity("Optima.Fais.Model.AssetOp", b =>
                {
                    ...
                    b.HasOne("Optima.Fais.Model.AssetNature", "AssetNatureFinal")
                        .WithMany()
                        .HasForeignKey("AssetNatureFinalId");

                    b.HasOne("Optima.Fais.Model.AssetNature", "AssetNatureInitial")
                        .WithMany()
                        .HasForeignKey("AssetNatureInitialId");
                    ...
                    b.HasOne("Optima.Fais.Model.BudgetManager", "BudgetManagerFinal")
                        .WithMany()
                        .HasForeignKey("BudgetManagerFinalId");

                    b.HasOne("Optima.Fais.Model.BudgetManager", "BudgetManagerInitial")
                        .WithMany()
                        .HasForeignKey("BudgetManagerInitialId");
                    ...
                    b.HasOne("Optima.Fais.Model.Dimension", "DimensionFinal")
                        .WithMany()
                        .HasForeignKey("DimensionFinalId");

                    b.HasOne("Optima.Fais.Model.Dimension", "DimensionInitial")
                        .WithMany()
                        .HasForeignKey("DimensionInitialId");
                    ...
                    b.HasOne("Optima.Fais.Model.Project", "ProjectFinal")
                        .WithMany()
                        .HasForeignKey("ProjectFinalId");

                    b.HasOne("Optima.Fais.Model.Project", "ProjectInitial")
                        .WithMany()
                        .HasForeignKey("ProjectInitialId");
