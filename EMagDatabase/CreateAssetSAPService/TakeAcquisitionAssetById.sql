CREATE PROCEDURE [dbo].[TakeAcquisitionAssetById]
@TakeAcquisitionAssetId INT
AS
SELECT top 1 [com].[Id], [com].[ASSET],[com].[ASVAL_DATE], 
...
[com].[WBS_ELEMENT]
      ...
      WHERE [com].[IsDeleted] = 0 AND [com].[NotSync] = 1 AND [com].[AssetId] = @TakeAcquisitionAssetId