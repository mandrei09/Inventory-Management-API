...
namespace Optima.Fais.EfRepository
{
    public class AreasRepository : Repository<Area>, IAreasRepository
    {
        ...
        public IEnumerable<Area> GetByFilters(string filter, string includes, string sortColumn, string sortDirection, int? page, int? pageSize)
        {
        ...
        private Expression<Func<Area, bool>> GetFiltersPredicate(string filter)
        {
