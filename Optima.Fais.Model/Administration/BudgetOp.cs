...
namespace Optima.Fais.Model
{
    public class BudgetOp : Entity
    {
        ...
        public int? CountryIdInitial { get; set; }

        public virtual Country CountryInitial { get; set; }

        public int? ActivityIdInitial { get; set; }

        public virtual Activity ActivityInitial { get; set; }
        ...
        public int? CountryIdFinal { get; set; }

        public virtual Country CountryFinal { get; set; }

        public int? ActivityIdFinal { get; set; }

        public virtual Activity ActivityFinal { get; set; }
        ...
        public int? BudgetStateIdFinal { get; set; }
