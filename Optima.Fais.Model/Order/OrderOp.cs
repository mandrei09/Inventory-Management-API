...
namespace Optima.Fais.Model
{
    public class OrderOp : Entity
    {
        ...
        public int? OfferIdInitial { get; set; }

        public virtual Offer OfferInitial { get; set; }

        public int? OfferIdFinal { get; set; }

        public virtual Offer OfferFinal { get; set; }
