...
{
    public class EmailOrderStatus : Entity
    {
		...
		public bool NotNeedContractSync { get; set; }

		public int SyncNeedContractErrorCount { get; set; }

		public bool NeedContractEmailSend { get; set; }
		...
		public bool EmployeeB1EmailSkip { get; set; }

		public bool EmployeeB1EmailSend { get; set; }

		public bool NotEmployeeB1Sync { get; set; }
		...
		[MaxLength(450)]
		public string EmployeeB1ValidateBy { get; set; }

		public ApplicationUser EmployeeB1ValidateUser { get; set; }
